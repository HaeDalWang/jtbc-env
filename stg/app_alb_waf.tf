...
resource "aws_iam_role_policy" "ec2_app_ssm_params" {
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Resource = "arn:aws:ssm:${data.aws_region.current.id}:277304862588:parameter/metaj-cms/stage/*"
    }]
  })
}
...
resource "aws_lb_listener" "https" {
  ...
  certificate_arn   = "arn:aws:acm:ap-northeast-2:277304862588:certificate/a79efdea-bf27-4a5a-a658-e0c8333e1eb5"
